            ...
            <div className="Work">
                ...
                <div className="Work__wrap">
                    <div className="Work__card">
                        <img src={require("./img/portfolio1.jpg")} alt=""/>
                    ...
                    <div className="Work__card">
                        <img src={require("./img/portfolio2.jpg")} alt="" />
                        <div className="Work__card__overlay">
                            <a href="#"><img src={require("./img/icon-plus.png")} alt="" /></a>
                            <div className="Work__card__overlay__desc">
                                <p>PARTNERSHIP GUIDELINES</p>
                    ...
                    <div className="Work__card">
                        <img src={require("./img/portfolio3.jpg")} alt="" />
                        <div className="Work__card__overlay">
                            <a href="#"><img src={require("./img/icon-plus.png")} alt="" /></a>
                            <div className="Work__card__overlay__desc">
                                <p>PARTNERSHIP GUIDELINES</p>
                    ...
                    <div className="Work__card">
                        <img src={require("./img/portfolio4.jpg")} alt="" />
                        <div className="Work__card__overlay">
                            <a href="#"><img src={require("./img/icon-plus.png")} alt="" /></a>
                            <div className="Work__card__overlay__desc">
                                <p>PARTNERSHIP GUIDELINES</p>
                    ...
                    <div className="Work__card">
                        <img src={require("./img/portfolio5.jpg")} alt="" />
                        <div className="Work__card__overlay">
                    ...
                    <div className="Work__card">
                        <img src={require("./img/portfolio6.jpg")} alt="" />
                        <div className="Work__card__overlay">
                            <a href="#">
                                <img src={require("./img/icon-plus.png")} alt="" />     
                            </a> 
